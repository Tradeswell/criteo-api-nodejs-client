...
type UpdateCampaign = RequireOnly<
  CampaignAttributes,
  'name' | 'budget' | 'clickAttributionWindow' | 'viewAttributionWindow'
>;
...
type UpdateLineItem = RequireOnly<
  LineItemAttributes,
  | 'name'
  | 'startDate'
  | 'endDate'
...
declare class Criteo_API {
  ...
  ): Promise<CampaignsResponse | undefined>;

  createCampaignByAccountId(
    accountId: string,
  ...
  getLineItemsByCampaignId(
    ...
    pageInfo?: PageInfo,
    callback?: (err: any, res: any) => void,
  ): Promise<LineItemsResponse | undefined>;

  createLineItemByCampaignId(
    campaignId: string,
    lineItemData: CreateLineItem,
    callback?: (err: any, res: any) => void,
  ): Promise<LineItemResponse | undefined>;
  ...
  updateLineItemById(
    lineItemId: string,
    lineItemData: UpdateLineItem,
    callback?: (err: any, res: any) => void,
  ): Promise<LineItemResponse | undefined>;

  getReport(
    reportType: 'campaigns' | 'line-items',
    query: ReportQuery,
    callback?: (err: any, res: any) => void,
  ): Promise<ReportStatusResponse | undefined | any>;

  getReportStatus(
    reportId: string,
    callback?: (err: any, res: any) => void,
  ): Promise<ReportStatusResponse | undefined>;
